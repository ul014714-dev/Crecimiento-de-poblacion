// ============================================================
//  LogiSim – Lógica del Modelo Logístico
//  P(t) = K / (1 + A * e^(-r*t))
//  donde  A = (K - P0) / P0
// ============================================================
...
const State = {
  ...
  P0:   0,          // Población infectada inicial
...
function validate() {
  ...
  if (P0 >= K)                 return { ok: false, msg: '⚠ Los infectados iniciales deben ser menores que la población total.' };
...
function drawChart() {
  ...
  ctx.textAlign = 'center';
  ctx.textBaseline = 'middle';
  ctx.fillText('Infectados P(t)', 0, 0);
  ctx.restore();
